...
implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        for (Player pl : Bukkit.getOnlinePlayers()) {
            ...
            pl.sendMessage(ChatColor.GREEN + "[*banner id=\"staff\"] Le joueur " + ChatColor.YELLOW + name + ChatColor.GREEN + " a \u00e9t\u00e9 temporairement banni pendant " + ChatColor.AQUA + args[1] + ChatColor.GREEN + " par " + ChatColor.YELLOW + sender.getName() + ChatColor.GREEN + " pour : " + ChatColor.RED + reason);
        }
        return true;
    }
}
