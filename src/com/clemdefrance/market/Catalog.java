...
public class Catalog implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            sendRemoteOpenMarketPacket(player, marketPacketId, "", "", -1, "", "", true);
        } else {
            ...
            sendRemoteOpenMarketPacket(player, marketPacketId, "", "", -1, "", search, true);
        }

        player.sendMessage("§aOuverture du catalogue...");
        return true;
    }
}